...
def check_certification(pk, sk, certification):
    c = scalar_mult(sk, pk)
...
# b = int(tuple(a)[1])
# c = int(tuple(a)[3])
# tup1 = (int(tuple(a)[1]), int(tuple(a)[3]))
# print(tup1)
# p = "483ada7726a3c4655da4fbfc0e1108a8fd17b448a68554199c47d08ffb10d4b8"
# print(len(p) * 4)
# a = bytes("123", encoding="utf8")
# print(type(hash_message(a)))
# print(inverse_mod(5, 3))
# print(3 % 5)
# a = "8a3637937e80e8309e64340e9e6417a58062c551c02d182ba4429ee4898bb37d"
# print(len(a))
# sig = {"msg_hash": "1a", "msg_sign": "2b"}
# print(str(sig))
